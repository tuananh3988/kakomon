        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-2">
                    <a href="<?= Url::to(['/quick/index']); ?>" class="btn btn-success"><i class="fa fa-reply"></i>&nbsp;&nbsp;Back</a>
                    <a href="<?= Url::to(['/quick/save', 'quizId' => $quizItem->quiz_id]); ?>" class="btn btn-success"><i class="fa fa-pencil-square-o"></i>&nbsp;&nbsp;Edit</a>
                </div>
            </div>
        </div>
    </div>
