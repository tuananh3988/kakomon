...
CREATE TABLE `follow` (
  ...
  `member_id_followed` int(11) NOT NULL,
  `member_id_following` int(11) NOT NULL,
  `delete_flag` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0: active, 1: delete',
  `updated_date` datetime DEFAULT NULL,
  `created_date` datetime DEFAULT NULL,
...
-- ----------------------------
-- Table structure for member_quiz_activity
-- ----------------------------
DROP TABLE IF EXISTS `member_quiz_activity`;
CREATE TABLE `member_quiz_activity` (
  `member_quiz_activity_id` int(11) NOT NULL AUTO_INCREMENT,
  `member_id` int(11) NOT NULL,
  `quiz_id` int(11) NOT NULL,
  `delete_flag` tinyint(4) DEFAULT '0' COMMENT '0: active, 1: delete',
  `updated_date` datetime DEFAULT NULL,
  `created_date` datetime DEFAULT NULL,
  PRIMARY KEY (`member_quiz_activity_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of member_quiz_activity
-- ----------------------------
...
CREATE TABLE `member_quiz_history` (
  ...
  `member_id` int(11) NOT NULL,
  `answer` varchar(255) NOT NULL COMMENT '00000000: lenght = 8',
  `correct_flag` tinyint(4) NOT NULL DEFAULT '1' COMMENT '1: correct, 2: incorrect, 3: not doing',
  `time` int(11) DEFAULT NULL COMMENT 'time of process question, couting by second',
  `created_date` datetime DEFAULT NULL,
...
CREATE TABLE `quiz` (
  ...
  `quiz_answer` varchar(255) DEFAULT NULL COMMENT '00000000 <-- lenght = 8',
